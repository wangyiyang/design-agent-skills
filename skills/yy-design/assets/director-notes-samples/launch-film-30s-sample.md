...
> Director's Notes for the **md-html v2.0** launch film
...
这不是 slogan，是世界观。Markdown 不是「一种轻量级文档格式」——它是写作的源头。一切下游的形式（html、docx、pdf、epub）都是从这同一个源头派生出的产物。md-html v2.0 把这条产物链从 4 条延长到 6 条——但延长的不是「功能列表」，是**源头的影响力半径**。
...
**主受众 A · 已使用 v1 的 md-html 老用户（约占 60% 流量）**
...
**次受众 B · 听说过 md-html 但没用的 AI Native 创作者（约 25%）**
...
- ✅ pause-and-look signature：PDF B 顶部的「大32开 · 176×240mm」中英混排，是 YY 生态对国内纸质书规格的尊重
