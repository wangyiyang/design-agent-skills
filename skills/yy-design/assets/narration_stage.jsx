...
const NarrationStageLib = (() => {
  ...
  function Subtitles({ bottom = 90, fontSize = 32, color = '#1a1a1a', haloColor = 'rgba(245,241,232,0.9)', maxLen = 13, karaoke = false, karaokeColor = '#e8590c', style = 'default' } = {}) {
    const isYyBrand = style === 'yy';
    const brandColor = isYyBrand ? '#00E676' : color;
    const brandHalo = isYyBrand ? 'rgba(10,10,10,0.35)' : haloColor;
    ...
    return React.createElement('div', {
      ...
      style: {
        fontFamily: '"PingFang SC", "Noto Sans SC", -apple-system, sans-serif',
        fontSize, fontWeight: 600, color: brandColor,
        letterSpacing: '0.04em', lineHeight: 1.2, textAlign: 'center',
        textShadow: `0 0 6px ${brandHalo}`,
        opacity: lineProg, transform: `translateY(${(1 - lineProg) * 4}px)`,
      },
    }, activeLine));
  }
