#!/usr/bin/env python3
"""
从 Wikimedia Commons 抓真实图片（公共领域 / CC），供 yy-design「内容型设计取真图」用（Phase 3.5）。
...
UA = "yy-design-image-fetcher/1.0 (local design skill; non-commercial)"
...
def main():
    ap = argparse.ArgumentParser(description="Wikimedia Commons 真图抓取（yy-design Phase 3.5）")
