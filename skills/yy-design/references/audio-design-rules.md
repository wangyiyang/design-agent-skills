...
> 实战锤炼：发布 hero v1-v9 迭代 · Anthropic 三支官方片子的 Gemini 深度拆解 · 8000+ 次 A/B 对比
...
本 skill 自带 6 首 BGM（`assets/bgm-*.mp3`）（该音频资产未随仓分发，需自备）：
...
- 发布 hero v9 实战案例：hero-animation-v9-final.mp4（作者本地样本，未随仓库分发）
