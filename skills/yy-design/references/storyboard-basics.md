...
>
> 方法论来源：配图库 300+ 张封面实测提炼的定格帧规则（S1-S11）、video-shotcraft 106 张镜头卡的能量骨架判例、HuaRec Studio 运镜导演系统的镜头预算公理。
...
配图库审美禁区全部继承，且要特别警惕动画的职业病：**发光粒子、数据流、全息 HUD、赛博霓虹是 motion graphics 最顺手的偷懒素材，恰好全在审美禁区**。做动画时手比做静态图更痒，管住。
